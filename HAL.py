...
from Knight_Nord import *
from Archer_Nord import *
from Wizard_Nord import *
...
def run():
    ...
    blue_knight = Knight_Nord(world, blue_knight_image, blue_base, Vector2(blue_base.spawn_position))
    ...
    blue_archer = Archer_Nord(world, blue_archer_image, blue_arrow_image, blue_base, Vector2(blue_base.spawn_position))
    ...
    blue_wizard = Wizard_Nord(world, blue_wizard_image, blue_rock_image, blue_base, Vector2(blue_base.spawn_position), blue_explosion_image)
